...
function UpdateTeam() {
  ...
  useEffect(() => {
    if (unitCode.length === 0 || semCode.length === 0 || teamName.length === 0)
      return;
        ...
        <div className="flex items-center p-8">
          <div className="mt-6 w-full max-w-2xl px-6 py-4 mx-auto bg-white rounded-md shadow-md">
            ...
            <p className="mt-3 text-left text-gray-600 ">
              ...
              code with year without spacing (eg. TMA2022) and select your team
              code (eg. if you're team 1 of class FTA then FTA01).
            </p>
              ...
              >
                ...
                <span
                  className={`text-sm font-medium ${
                    showDropdown && "transition-all group-hover:mr-4"
                  }`}
                >
                  Update
                </span>
