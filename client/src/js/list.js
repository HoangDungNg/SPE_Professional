const SPE1Questions = [
  ...
  {
    question: "Problem solving and creativity on behalf of the group's work.",
    inputType: "fieldset",
  },
  {
    question:
      "Below add a brief description of how you believe you contributed to the project process over the whole semester.",
    inputType: "textarea",
  },
  {
    question:
...
const SPE2Questions = [
  {
    question: "The amount of work and effort put into the project as a whole.",
    inputType: "fieldset",
  },
  {
    question:
...
export { SPE1Questions, SPE2Questions };
